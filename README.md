...
git clone https://github.com/USERNAME/symfony-agency-cms.git
...
In der Datei `.env` die Datenbankverbindung anpassen:



```env

DATABASE\_URL="mysql://root:@127.0.0.1:3306/symfony\_agency\_cms?serverVersion=mariadb-10.4.32\&charset=utf8mb4"
...
\- Rollenbasierter Zugriff mit `ROLE\_ADMIN`
